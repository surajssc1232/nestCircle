"""
Django settings for resource_sharing project.
...
SECRET_KEY = 'k_9e5-wa03md^y^g9-0u^8(84ssxbla1gx7tnfw1@)sywhkeye'
...
ROOT_URLCONF = 'resource_sharing.urls'
...
WSGI_APPLICATION = 'resource_sharing.wsgi.application'
